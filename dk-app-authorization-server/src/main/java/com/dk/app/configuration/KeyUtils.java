...
public class KeyUtils {
    ...
    private String accessTokenPrivateKetPath;
    ...
    private KeyPair getAccessTokenKeyPair() {
        if (Objects.isNull(_accessTokenKeyPair)) {
            _accessTokenKeyPair = getKeyPair(accessTokenPublicKeyPath, accessTokenPrivateKetPath);
        }
    ...
    private KeyPair getKeyPair(String publicKeyPath, String privateKeyPath) {
        ...
        if (publicKeyFile.exists() && privateKeyFile.exists()) {
            ...
            if (Arrays.stream(environment.getActiveProfiles()).anyMatch(s -> s.equals("prod"))) {
                ...
                throw new RuntimeException("private and public keys don't exist");
            }
        }
